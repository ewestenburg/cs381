...
void TranslateAndDraw(raylib::Model& model, const raylib::Vector3& position, const raylib::Vector3& scale, const raylib::Vector3& axis, const float& angle, const raylib::Color& color) {
    ...
    DrawModel(model, position, 0.01f, color);

    // Draw bounding box
    //DrawBoundingBox(model.mesh.bounds, position, 1.0f, color);
}
...
int main() {
    ...
    raylib::Model ship = LoadModel("/home/ashton/cs381/as1/381Resources/meshes/ddg51.glb");
