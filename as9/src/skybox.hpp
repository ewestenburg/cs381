...
namespace cs381 {
	struct SkyBox {
		...
		constexpr static std::string_view vertexShader =
			#include "../generated/glsl330/skybox.vs"
		;
		constexpr static std::string_view fragmentShader =
			#include "../generated/glsl330/skybox.fs"
		;
		constexpr static std::string_view cubemapVertexShader =
			#include "../generated/glsl330/cubemap.vs"
		;
		constexpr static std::string_view cubemapFragmentShader =
			#include "../generated/glsl330/cubemap.fs"
		;
	#else
		constexpr static std::string_view vertexShader =
			#include "generated/glsl100/skybox.vs"
		;
		constexpr static std::string_view fragmentShader =
			#include "generated/glsl100/skybox.fs"
		;
		constexpr static std::string_view cubemapVertexShader =
			#include "generated/glsl100/cubemap.vs"
		;
		constexpr static std::string_view cubemapFragmentShader =
			#include "generated/glsl100/cubemap.fs"
		;
	#endif
